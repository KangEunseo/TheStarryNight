function shareKakaotalk() {
    ...
    Kakao.Link.sendDefault({
        ...
        , content : {
            ...
            , link : {
                  mobileWebUrl:"https://kangeunseo.github.io/TheStarryNight/"   // 모바일 카카오톡에서 사용하는 웹 링크 URL
                , webUrl:"https://kangeunseo.github.io/TheStarryNight/index-d" // PC버전 카카오톡에서 사용하는 웹 링크 URL
            }
        }
        , buttons : [
            {
